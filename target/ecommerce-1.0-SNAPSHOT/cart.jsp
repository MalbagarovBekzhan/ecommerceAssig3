...
<section id="team" class="team section-bg">
    <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
            <h2>Your cart</h2>
            <p>Шf you do not purchase items within a minute, they will be reset</p>
        </div>
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
                <div class="member">
                    <div class="member-img">
                        <img src="img/ee.jpg" class="img-fluid" alt="">
        ...
        <div class="section-title">
            ...
            <form action="sessionmanagenment" method="post">
                <input type="submit"  value="buy" class="get-started-btn ">
            </form>
